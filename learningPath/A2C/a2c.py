...
from learningPath.utils.networks import tfSummary
from learningPath.utils.stats import gather_stats
...
class A2C:
    ...
    def train(self, env, args, summary_writer, model_save_dir=None):
        ...
        for e in tqdm_e:
            ...
            if model_save_dir is not None and (e + 1) % 100 == 0:
                export_path = '{}checkpoint_{}_score_{}'.format(model_save_dir,
                                                                e + 1,
                                                                cumul_reward)
