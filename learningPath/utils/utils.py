...
from gym.envs.user.yeung_knowledge_tracing_utils.load_data import OriginalInputProcessor
from gym.envs.user.yeung_knowledge_tracing_utils.model import Model
...
class DKT(object):
    ...
    def predict(self, X):
        ...
        # preds.shape: (-1, num_steps, num_problems)
        preds = sess.run(
            model.preds,
            feed_dict=feed_dict
        )
